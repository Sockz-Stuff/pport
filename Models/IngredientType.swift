...
let TestIngredientModel1 = Ingredient(id: "1", name: "Steak", amount: "4", type: "Meat", unit: "LB")
let TestIngredientModel2 = Ingredient(id: "2", name: "Chicken", amount: "13", type: "Meat", unit: "LB")
let TestIngredientModel3 = Ingredient(id: "3", name: "Ground Beef", amount: "2", type: "Meat", unit: "LB")
let TestIngredientModel4 = Ingredient(id: "4", name: "Fish", amount: "6", type: "Meat", unit: "LB")
